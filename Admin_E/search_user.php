...
if (isset($_POST['download_pdf'])) {
    // Fetch data from the database and generate HTML tables
    ob_start(); // Start output buffering

    // Your existing PHP code to fetch data and generate HTML tables
    // ...
...
<?php
    ...
    $pdf->SetHeaderData('', 0, 'Financial Report', '');
...
<body>
    <form action="" method="post">
        <button type="submit" name="download_pdf">Download Report</button>
    </form>
</body>
